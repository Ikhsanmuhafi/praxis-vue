            ...
            <v-row class="justify-center">
                <v-col>
                    <v-card tile elevation="1" class="mt-10">
                        <v-parallax
                          src="https://d117h1jjiq768j.cloudfront.net/images/default-source/blogs/2018/2018-12/developers-vs-low-code-what-they-think-and-why_870x433.jpg?sfvrsn=49bddde3_1">
                          <v-card-title> 
                            <h3>Registrasi</h3>
                        </v-card-title>
                        <v-form ref="form">
                            <v-card-text>
                                <v-text-field color="white" label="Nama" v-model="user.name" :rules="nameRules"/>
                                <v-text-field color="white" label="Alamat" v-model="user.address" :rules="addressRules"/>
                                <v-select
                                :items="programs"
                                color="white"
                                label="Program"
